...
//
//----------------------------------------------------------------------
/*!\file    plugins/network_transport/generic_protocol/tNetworkServerPort.h
 *
...
public:
  ...
  tNetworkServerPort(tRemoteRuntime& remote_runtime, core::tFrameworkElement* parent, const std::string& name, rrlib::rtti::tType type, core::tFrameworkElementFlags flags);

  /*!
   * Called by network thread. Sends any enqueued calls.
   */
  void DoSendCalls();
...
private:
  ...
  /*! Reference to remote runtime that this port belongs to */
